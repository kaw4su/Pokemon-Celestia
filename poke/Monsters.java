...
public enum Monsters {
    ...
    SERPERIOR("Serperior", (int)354, (int)273, (int)317, (int)357, new AttackMove[]{AttackMove.LEAFSTORM, AttackMove.LEAFBLADE, AttackMove.AERIALACE, AttackMove.AQUATAIL}. Type.GRASS),
    ...
    GOODRA("Goodra", (int)384, (int)328, (int)262, (int)284, new AttackMove[]{AttackMove.POWERWHIP, AttackMove.DRAGONPULSE, AttackMove.DRAGONBREATH, AttackMove.MUDDYWATER}, Type.DRAGON),
